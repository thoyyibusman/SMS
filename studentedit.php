...
if (isset($_POST['update'])) {
    ...
    $sql1 = "UPDATE student SET name='$name', dob='$dob', email='$email', contact='$contact', place='$place', address='$address' WHERE id='$id'";
                        ...
                        <div class="row mb-3">
                                ...
                                <p  class=" border text-dark"><?php
                                    if(!empty($row['img'])){
                                     ...
                                     ?><br><br><button class=" btn "><a class="text-decoration-none " href = "seditimg.php?id=<?php echo $row['id'];?>">Edit Image</a></button>
